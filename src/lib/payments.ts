...
export const paymentMethods: { id: PaymentMethod; label: string; description: string }[] = [
  ...
  { id: "klarna", label: "Klarna", description: "Pay in 4 interest-free installments" },
  { id: "afterpay", label: "Afterpay", description: "Pay in 4 interest-free installments" },
  { id: "sezzle", label: "Sezzle", description: "Pay in 4 interest-free installments" },
