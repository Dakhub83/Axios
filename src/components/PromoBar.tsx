...
export default function PromoBar() {
  ...
  return (
    <div className="relative flex items-center justify-center bg-accent px-10 py-2 text-center text-black">
      ...
      <button
        ...
        onClick={dismiss}
        aria-label="Dismiss"
        className="absolute right-3 top-1/2 -translate-y-1/2 text-black/70 transition-colors hover:text-black"
      >
